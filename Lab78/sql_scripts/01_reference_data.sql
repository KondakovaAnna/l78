...
select * from dbo.alignment;

DROP TABLE IF EXISTS  dbo.superpower;
...
DROP TABLE IF EXISTS  dbo.superhero_temp;
DROP TABLE IF EXISTS  dbo.hero_attribute;
...
INSERT INTO  dbo.alignment VALUES (1,'Good'),
(2,'Bad'),
(3,'Neutral'),
(4,'N/A');
...
INSERT INTO  dbo.attribute VALUES
(1,'Intelligence'),
(2,'Strength'),
(3,'Speed'),
(4,'Durability'),
...
INSERT INTO  dbo.colour VALUES (1,'No Colour'),
(2,'Amber'),
(3,'Auburn'),
(4,'Black'),
(5,'Black/Blue'),
...
INSERT INTO  dbo.publisher VALUES (1,''),
(2,'ABC Studios'),
(3,'Dark Horse Comics'),
(4,'DC Comics'),
(5,'George Lucas'),
...
CREATE TABLE  dbo.superhero (
  ...
  PRIMARY KEY (id),
  CONSTRAINT fk_sup_align FOREIGN KEY (alignment_id) REFERENCES  dbo.alignment (id),
  CONSTRAINT fk_sup_eyecol FOREIGN KEY (eye_colour_id) REFERENCES  dbo.colour (id),
  CONSTRAINT fk_sup_gen FOREIGN KEY (gender_id) REFERENCES  dbo.gender (id),
  CONSTRAINT fk_sup_haircol FOREIGN KEY (hair_colour_id) REFERENCES  dbo.colour (id),
  CONSTRAINT fk_sup_pub FOREIGN KEY (publisher_id) REFERENCES  dbo.publisher (id),
  CONSTRAINT fk_sup_race FOREIGN KEY (race_id) REFERENCES  dbo.race (id),
  CONSTRAINT fk_sup_skincol FOREIGN KEY (skin_colour_id) REFERENCES  dbo.colour (id)
);

INSERT INTO  dbo.superhero VALUES
...
INSERT INTO  dbo.superpower VALUES (1,'Agility'),
